...
- **New, unused items** in original packaging are typically eligible for return within **30 days** of delivery, unless a product page states otherwise (e.g. clearance or personal-use items).
- **Opened or used items** may be limited to exchange or store credit, depending on category and condition.
...
- **Approved refunds** are applied to the original payment method when possible, within a reasonable time after we receive and inspect the return.
- **Shipping** on returns may be the customer’s responsibility unless the return is due to our error or a defective item.
